// Define the types for filter items and filter data
...
// Define filterData with proper typing
...
// Define the types for filter values and their return values
...
interface FilterReturnValue {
  name: string;
  value?: string;
}

// getFilterValues function with proper typing
export const getFilterValues = (filterValues: FilterValues): FilterReturnValue[] => {
  const {
    purpose,
    rentFrequency,
    categoryExternalID,
  ...
  const values: FilterReturnValue[] = [
