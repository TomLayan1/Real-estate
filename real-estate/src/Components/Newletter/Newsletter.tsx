        ...
        <div className='container'>
          <div className='w-full md:w-[60%] lg:w-[30%] mx-auto mb-28 md:mb-16'>
            ...
            <form className='w-[95%] mx-auto bg-white flex items-center justify-between rounded-full py-1 pl-5 pr-1'>
              ...
              <input type='text' placeholder='Enter your Email' className='w-[220px] py-2 px-2 text-sm' />
              <button type='submit' className='w-[100px] py-2 bg-primaryColor text-white text-sm rounded-full'>Submit</button>
            </form>
          </div>
          <h1 className='text-7xl md:text-9xl font-extrabold text-gray-400 text-opacity-35 tracking-widest text-center'>Realtor</h1>
        </div>
      </div>
    </section>
  )
