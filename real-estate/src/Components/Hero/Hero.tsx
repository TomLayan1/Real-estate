    ...
    <div className='relative w-full h-[750px] md:h-[655px] hero-bx'>
      <div className='absolute w-full h-full pt-40 bg-heroBg'>
        <div className='container'>
          ...
          <p className='text-lg text-center text-white md:w-[60%] mx-auto'>Explore the finest properties, tailored to your lifestyle. Whether buying, renting, or investing, discover your perfect space with us.</p>
        </div>
      </div>
    </div>
  )
